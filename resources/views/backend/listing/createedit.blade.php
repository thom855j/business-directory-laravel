...
<h1>{{ ($listing->id)?'Edit Listing':'Create Listing' }}</h1>

<hr/>

<form action="{{ ($listing->id) ? URL::to('admin/listing/edit/'.$listing->id) : URL::to('admin/listing/edit') }}" method="post" enctype="multipart/form-data">
...
<div class="row">
	<div class="col-md-8">
	    ...
	    <div class="row data-block">
	        ...
	        <div class="col-sm-3 form-group">
	        	<select name="verified" class="form-control">
	        		<option value="0" {{ ($listing->verified == false) || Request::old('verified') == "0" ? 'selected' : '' }}>No</option>
	        		<option value="1" {{ ($listing->verified == true) || Request::old('verified') == "1" ? 'selected' : '' }}>Yes</option>
	        	</select>
	        </div>
	    </div>
	    ...
	    <div class="row data-block">
	        ...
	        <div class="col-sm-3 form-group">
	        	<select name="approved" class="form-control">
	        		<option value="0" {{ ($listing->approved == false) || Request::old('approved') == "0" ? 'selected' : '' }}>No</option>
	        		<option value="1" {{ ($listing->approved == true) || Request::old('approved') == "1" ? 'selected' : '' }}>Yes</option>
	        	</select>
	        </div>
	    </div>
	    ...
	    <div class="row data-block">
	    	<div class="col-sm-3">
	        	<label for="approved" class="control-label">User</label>
	        </div>
        ...
        <div class="pull-right">
        	...
        	<a href="{{ URL::to('admin/listings') }}"><div class="btn btn-default">Cancel</div></a>
          	<button type="submit" class="btn btn-success">{!! ($listing->id)?'<i class="fa fa-check"></i> Save':'Create' !!}</button>
...
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&region=AU&language=en-AU"></script>
